class org.lync.events.EventDispatcher
{
	...
	static function _removeEventListener(queue:Object, event:String, func):Void
	{
		if (queue != undefined)
		{
	...
	function dispatchQueue(queueObj:Object, eventObj:Object):Void
	{
		...
		if (queue != undefined)
		{
			...
			for (i in queue)
			{
				...
				// a func can be a function, object, or movieclip
	...
	*/
	function addEventListener(event:String, func:Function):Void
	{
		...
		EventDispatcher._removeEventListener(this[queueName], event, func);
		this[queueName].push(func);
	}
	...
	* @param the function or object that should be called
	*/
	function removeEventListener(event:String, func:Function):Void
	{
		var queueName:String = "__q_" + event;
		EventDispatcher._removeEventListener(this[queueName], event, func);
	}
